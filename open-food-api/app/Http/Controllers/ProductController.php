...
class ProductController extends Controller
{
    ...
    public function importProducts()
    {
        ...
        try {
            while ($page <= 5) {
                $response = Http::timeout(60)->retry(3, 100)->get("https://world.openfoodfacts.org/api/v2/search.json", [
                    'page' => $page,
                    'page_size' => 20, 
                    'fields' => 'code',
                ]);
                ...
                foreach ($products as $product) {
                    ...
                    $productDetail = Http::timeout(60)->retry(3, 100)->get("https://world.openfoodfacts.org/api/v2/product/{$code}.json");
    ...
    public function getProduct($barcode)
    {
        ...
        return response()->json([
            'message' => 'Produto não encontrado ou erro na requisição',
